...
<li><a class="active_1" href="espace.php">ESPACE ETUDIANT</a></li>
...
<div class="trending" style="background-color: #f5f5f5; ">
	<h2 style="margin-top: 0 !important;"><span>GUIDE DE LՃTUDIANT</span></h2>
...
<section>
	<div class="row">
		<div class="column">
			<img src="../static/img/guide1.png">
			<img src="../static/img/guide2.png">
